...
init_logging() ->
    ...
    XdcrDebugLogPath = filename:join(Dir, ?XDCR_DEBUG_LOG_FILENAME),
    ...
    ok = ale:start_sink(disk_xdcr_debug,
                        ale_disk_sink, [XdcrDebugLogPath, DiskSinkParams]),
    ...
    MainFilesLoggers = AllLoggers -- [?XDCR_LOGGER, ?XDCR_DEBUG_LOGGER,
                                      ?COUCHDB_LOGGER],
    ...
    ok = ale:add_sink(?XDCR_DEBUG_LOGGER, disk_xdcr_debug, debug),
