     ...
     {struct,[{blockName,<<"DCP Queues">>},
              ...
              {stats,
               [{struct,[{title,<<"DCP connections">>},
                         ...
                         {desc,<<"Number of internal replication DCP connections in this bucket (measured from ep_upr_replica_count)">>}]},
                {struct,[{title,<<"DCP connections">>},
                         {name,<<"ep_upr_xdcr_count">>},
                         {desc,<<"Number of internal xdcr DCP connections in this bucket (measured from ep_upr_xdcr_count)">>}]},
                {struct,[{title,<<"DCP connections">>},
                         {name,<<"ep_upr_views_count">>},
                         {desc,<<"Number of internal views DCP connections in this bucket (measured from ep_upr_views_count)">>}]},
                {struct,[{title,<<"DCP connections">>},
                         {name,<<"ep_upr_other_count">>},
                         {desc,<<"Number of other DCP connections in this bucket (measured from ep_upr_other_count)">>}]},
                ...
                {struct,[{title,<<"drain rate bytes/sec">>},
                         ...
                         {desc,<<"Number of bytes per second being sent for replication DCP connections for this bucket (measured from ep_upr_replica_total_bytes)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_xdcr_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for xdcr DCP connections for this bucket (measured from ep_upr_xdcr_total_bytes)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_views_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for views DCP connections for this bucket (measured from ep_upr_views_total_bytes)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_other_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for other DCP connections for this bucket (measured from ep_upr_other_total_bytes)">>}]}
               ]}]}]
        ++ couchbase_view_stats_descriptions(BucketId)
        ++ couchbase_replication_stats_descriptions(BucketId)
