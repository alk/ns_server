...
membase_stats_description(BucketId) ->
    [{struct,[{blockName,<<"Summary">>},
     ...
     {struct,[{blockName,<<"Upr Queues">>},
              ...
              {stats,
               [{struct,[{title,<<"UPR connections">>},
                         {name,<<"ep_upr_replica_count">>},
                         {desc,<<"Number of internal replication UPR connections in this bucket (measured from ep_upr_replica_count)">>}]},
                {struct,[{title,<<"UPR connections">>},
                         {name,<<"ep_upr_xdcr_count">>},
                         {desc,<<"Number of internal xdcr UPR connections in this bucket (measured from ep_upr_xdcr_count)">>}]},
                {struct,[{title,<<"UPR connections">>},
                         {name,<<"ep_upr_views_count">>},
                         {desc,<<"Number of internal views UPR connections in this bucket (measured from ep_upr_views_count)">>}]},
                {struct,[{title,<<"UPR connections">>},
                         {name,<<"ep_upr_other_count">>},
                         {desc,<<"Number of other UPR connections in this bucket (measured from ep_upr_other_count)">>}]},
                {struct,[{title,<<"UPR senders">>},
                         {name,<<"ep_upr_replica_producer_count">>},
                         {desc,<<"Number of replication senders for this bucket (measured from ep_upr_replica_producer_count)">>}]},
                {struct,[{title,<<"UPR senders">>},
                         {name,<<"ep_upr_xdcr_producer_count">>},
                         {desc,<<"Number of xdcr senders for this bucket (measured from ep_upr_xdcr_producer_count)">>}]},
                {struct,[{title,<<"UPR senders">>},
                         {name,<<"ep_upr_views_producer_count">>},
                         {desc,<<"Number of views senders for this bucket (measured from ep_upr_views_producer_count)">>}]},
                {struct,[{title,<<"UPR senders">>},
                         {name,<<"ep_upr_other_producer_count">>},
                         {desc,<<"Number of other senders for this bucket (measured from ep_upr_other_producer_count)">>}]},
                {struct,[{title,<<"items remaining">>},
                         {name,<<"ep_upr_replica_items_remaining">>},
                         {desc,<<"Number of items remaining to be sent to producer in this bucket (measured from ep_upr_replica_items_remaining)">>}]},
                {struct,[{title,<<"items remaining">>},
                         {name,<<"ep_upr_xdcr_items_remaining">>},
                         {desc,<<"Number of items remaining to be sent to producer in this bucket (measured from ep_upr_xdcr_items_remaining)">>}]},
                {struct,[{title,<<"items remaining">>},
                         {name,<<"ep_upr_views_items_remaining">>},
                         {desc,<<"Number of items remaining to be sent to producer in this bucket (measured from ep_upr_views_items_remaining)">>}]},
                {struct,[{title,<<"items remaining">>},
                         {name,<<"ep_upr_other_items_remaining">>},
                         {desc,<<"Number of items remaining to be sent to producer in this bucket (measured from ep_upr_other_items_remaining)">>}]},
                {struct,[{title,<<"drain rate items/sec">>},
                         {name,<<"ep_upr_replica_items_sent">>},
                         {desc,<<"Number of items per second being sent for a producer for this bucket (measured from ep_upr_replica_items_sent)">>}]},
                {struct,[{title,<<"drain rate items/sec">>},
                         {name,<<"ep_upr_xdcr_items_sent">>},
                         {desc,<<"Number of items per second being sent for a producer for this bucket (measured from ep_upr_xdcr_items_sent)">>}]},
                {struct,[{title,<<"drain rate items/sec">>},
                         {name,<<"ep_upr_views_items_sent">>},
                         {desc,<<"Number of items per second being sent for a producer for this bucket (measured from ep_upr_views_items_sent)">>}]},
                {struct,[{title,<<"drain rate items/sec">>},
                         {name,<<"ep_upr_other_items_sent">>},
                         {desc,<<"Number of items per second being sent for a producer for this bucket (measured from ep_upr_other_items_sent)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_replica_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for replication UPR connections for this bucket (measured from ep_upr_replica_total_bytes)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_xdcr_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for xdcr UPR connections for this bucket (measured from ep_upr_xdcr_total_bytes)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_views_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for views UPR connections for this bucket (measured from ep_upr_views_total_bytes)">>}]},
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_other_total_bytes">>},
                         {desc,<<"Number of bytes per second being sent for other UPR connections for this bucket (measured from ep_upr_other_total_bytes)">>}]}
               ]}]}]
        ++ couchbase_view_stats_descriptions(BucketId)
        ++ couchbase_replication_stats_descriptions(BucketId)
