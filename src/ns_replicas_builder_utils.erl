...
kill_a_bunch_of_tap_names(Bucket, Node, TapNames) ->
    case ns_config_ets_dup:unreliable_read_key(spend_sockets_on_kinda_fast_kill_a_bunch_of_tap_names, undefined) of
        undefined ->
            ns_memcached:kill_a_bunch_of_tap_names(Bucket, Node, TapNames);
        _ ->
            kill_a_bunch_of_tap_names_old_style(Bucket, Node, TapNames)
    end.
